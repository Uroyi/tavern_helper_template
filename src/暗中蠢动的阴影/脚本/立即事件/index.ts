$(async () => {
  ...
  injectPrompts([
    ...
    },
    {
      ...
      content: '【【露露拉拉·姐妹争吵】】',
      filter: () =>
        (get('世界.角色出场状态.露露.已认识') === true || get('世界.角色出场状态.拉拉.已认识') === true) &&
        get('露露拉拉.好感度') >= 5 &&
        !get('露露拉拉.支线完成.SQ1') &&
        get('世界.当前地点') === '旅店',
      should_scan: true,
